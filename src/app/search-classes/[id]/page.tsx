        ...
        <div className="md:col-span-2 space-y-8">
          ...
          <Card>
            ...
            <CardContent className="text-muted-foreground space-y-4">
              <p>
                Esta es una descripción detallada de la clase de {classData.name}. Aquí, el instructor explicaría la dinámica de la clase, los objetivos de aprendizaje, el nivel requerido y qué pueden esperar los estudiantes. Es una oportunidad para vender la experiencia y conectar con potenciales alumnos.
              </p>
               <p>
                Por ejemplo, en una clase de {classData.subCategory} nivel {classData.level}, se podría hablar de los pasos que se enseñarán, la música que se usará o el enfoque en técnica versus estilo.
              </p>
            </CardContent>
          </Card>
